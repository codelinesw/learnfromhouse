					  		...
					  		<div className="card col-md-11 p-3 rounded-10 border-0">
					  			<div className="card-header bg-transparent border-0 d-flex justify-content-start">
						  			<div className="column col-md-7 ml-0">
										...
										<p className="text-break font-weight-light">Este es el catalogo de profesores que pertenecen a la institucion a la que te encuentras registrado <Link to={{pathname:'/institutions'}}>Aqui</Link></p>
						  			</div>
					  			</div>
					  								...
					  								<div className="table-filter">
															<div className="row">
											                    <div className="d-flex align-items-center justify-content-between">
																	...
																	<div className="filter-group d-flex align-items-center mr-3">
																		<label className="mr-3" style={{position:'relative',marginRight:'10px',top:'3px'}}>Especialidad:</label>
																		<select className="form-control col-md-7" defaultValue="DEFAULT" style={{position:'relative',top:'-2px'}}>
																	...
																	<div className="input-group mb-3 col-sm-4" style={{position:'relative',top:'5px'}}>

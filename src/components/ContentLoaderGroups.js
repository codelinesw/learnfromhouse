...
export default class ContentLoadGroups extends React.Component{
							...
							<td style={{padding:'0px',width:'200px'}}>
								<ContentLoader
									width={110}
				   					...
				   					speed={3}
								>
									<rect x="8" y="16" rx="3" ry="4" width="100" height="9" />
								</ContentLoader>
							</td>
							<td style={{padding:'0px',width:'460px'}}>
								<ContentLoader
									width={220}
								   height={45}
								   backgroundColor="#e3e3e3"
								   ...
								   speed={3}
								>
									<rect x="12" y="16" rx="3" ry="4" width="160" height="9" />
								</ContentLoader>
							</td>
							<td style={{padding:'0px'}}>
								<ContentLoader
									width={170}
				   					...
				   					speed={3}
								>
									<rect x="15" y="16" rx="3" ry="4" width="70" height="9" />
								</ContentLoader>
							</td>
							<td style={{padding:'0px'}}>
								<ContentLoader
